...
/***/ (function(module, exports, __webpack_require__) {
	...
	// WX-TO-DO 需要 wx.getSystemInfo 获取更详细信息
	var _wx$getSystemInfoSync = wx.getSystemInfoSync(),
	    platform = _wx$getSystemInfoSync.platform
	...
	var navigator = {
	  ...
	  onLine: true, // WX-TO-DO 用 wx.getNetworkStateChange 和 wx.onNetworkStateChange 来返回真实的状态

	  // WX-TO-DO 用 wx.getLocation 来封装 geolocation
	  geolocation: {
...
/***/ (function(module, exports) {
	...
	var XMLHttpRequest = function () {
	  // WX-TO-DO 没法模拟 HEADERS_RECEIVED 和 LOADING 两个状态
...
/***/ (function(module, exports) {
	...
	var WebSocket = function () {
	  ...
	  function WebSocket(url) {
	    ...
	    return this
	  } // WX-TO-DO 小程序内目前获取不到，实际上需要根据服务器选择的 sub-protocol 返回
	  // WX-TO-DO 更新 bufferedAmount
